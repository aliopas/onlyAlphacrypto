                ...
                <div className="flex items-start gap-3 p-4 bg-[#0A0A0A] border border-[#1A1A1A] rounded-lg">
                    ...
                    <div>
                        ...
                        <p className="text-[11px] text-[#555] leading-relaxed">
                            This content is generated by AI-powered data analysis and is provided for <span className="text-[#888]">informational purposes only</span>. It does <span className="text-[#888] font-medium">not</span> constitute financial advice, investment recommendations, or solicitation to buy, sell, or hold any cryptocurrency or digital asset. OnlyAlpha is <span className="text-[#888] font-medium">not</span> a registered financial advisor, broker, or dealer. All market data, sentiment indicators, and trend strength scores are derived from publicly available sources and algorithmic analysis — they reflect data patterns, not predictions. Cryptocurrency markets are highly volatile and you may lose your entire investment. Always conduct your own research (DYOR) and consult a licensed financial professional before making any investment decisions. OnlyAlpha assumes <span className="text-[#888] font-medium">no liability</span> for any losses incurred based on information presented on this platform.
                        </p>
                    </div>
                </div>
            </div>
