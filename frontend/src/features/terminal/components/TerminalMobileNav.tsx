    ...
    return (
        <nav className="flex-none lg:hidden w-full bg-[#0A0A0A] border border-[#333] grid grid-cols-3 p-1 rounded-md relative shrink-0">
            <button
                ...
                className={`w-full flex justify-center items-center gap-1.5 py-2 transition-all outline-none rounded-[4px] ${activeTab === 'wire' ? 'bg-[#181818] border border-[#555] text-white shadow-sm' : 'bg-transparent border border-transparent text-[#555] hover:text-[#888]'}`}
            >
            ...
            <button
                ...
                className={`w-full flex justify-center items-center gap-1.5 py-2 transition-all outline-none rounded-[4px] ${activeTab === 'chat' ? 'bg-[#181818] border border-[#555] text-white shadow-sm' : 'bg-transparent border border-transparent text-[#555] hover:text-[#888]'}`}
            >
